...
public class OrcUtils {
    public static Object convertOrcToPig(Object obj, ObjectInspector oi, boolean[] includedColumns) {
        ...
        case STRUCT:
            ...
            if (items != null) { // to account for ORC's book-keeping inside file stripes
    ...
    public static Object getPrimaryFromOrc(Object obj, PrimitiveObjectInspector poi) {
        ...
        case SHORT:
            ...
            break;
        case BINARY:
            byte[] bytes = (byte[]) poi.getPrimitiveJavaObject(obj);
            result = new DataByteArray(bytes);
            break;
        case TIMESTAMP:
    ...
    public static Object getPrimaryFromPig(Object obj, PrimitiveObjectInspector poi) throws IOException {
        ...
        case DECIMAL:
            if (obj instanceof BigDecimal) {
                ...
                throw new IOException("Should never happen, expect BigDecimal/BigInteger, but get " + obj.getClass());
            }
            break;
        case BINARY:
            if (obj instanceof DataByteArray) {
                DataByteArray dba = (DataByteArray)obj;
                result = ((SettableBinaryObjectInspector)poi).create(dba.get());
            }
            break;
        case DATE:
        case BYTE:
    ...
    AbstractPrimitiveJavaObjectInspector implements BinaryObjectInspector {
        ...
        public BytesWritable getPrimitiveWritableObject(Object o) {
            return o == null ? null : new BytesWritable(((DataByteArray) o).get());
        }
